...
exports.App = function () {
  ...
  var setCurrentSong = function setCurrentSong(path, cb) {
  ...
  var vKey = function vKey(targetKeyCode, path) {
    return React.createElement("div", { onKeyPress: function onKeyPress(event) {
  ...
  //as input.
  var init = function init(keyBindings) {
    var result = "";
